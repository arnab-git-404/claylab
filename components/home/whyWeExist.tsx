...
//         {/* Vision Section */}
//       <div className="w-full mt-12 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border-l-4 border-green-500">
...
// const WhyWeExist = () => {
//   return (
//     <section className="py-8 sm:py-10 px-2 sm:px-4 md:px-16 bg ">
...
//       {/* Vision Section - Full Width Below */}
//       <div className="w-full p-6 sm:p-8 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border-l-4 border-green-500">
//         <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-700 mb-6">
//           At Claylab, we exist to change this.
//         </h3>
...
const WhyWeExist = () => {
  return (
    <section className="relative py-8 sm:py-10 px-2 sm:px-4 md:px-16 overflow-hidden">
      {/* Background Image */}
      {/* <div className="absolute inset-0 z-1">
        <Image
          src="/claylab assets/home/whyWeExist/image.png"
          alt="Background"
          fill
      ...
      <div className="relative z-10">
        ...
        {/* Vision Section - Full Width Below */}
        <div className="w-full p-6 sm:p-8 bg-gradient-to-r from-green-50/90 to-blue-50/90 backdrop-blur-sm rounded-xl border-l-4 border-green-500">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-700 mb-6">
            At Claylab, we exist to change this.
          </h3>
