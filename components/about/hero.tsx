  ...
  return (
    <section className="relative w-full h-[60vh] sm:h-screen flex items-center overflow-hidden">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 mx-4 sm:mx-8 md:mx-14 mt-16 sm:mt-32 text-start max-w-full sm:max-w-4xl z-10">
        ...
        <h3 className="text-2xl mt-4 -mb-2 sm:text-8xl md:text-7xl sm:mb-[-4px] text-white font-caliSign z-[5]">Our Story</h3>
        <p style={{ fontWeight: "100" }} className="text-lg sm:text-xs md:text-lg text-white/70 mb-4 sm:mb-8 max-w-full sm:max-w-6xl z-[10] font-sourceSans font-thin">
