...
// //         // <div className="flex flex-col items-start justify-center text-left space-y-6 sm:space-y-8 lg:space-y-10">
...
// //         //     At Claylab, mentorship isn&apos;t just support — it&apos;s a relationship of trust, empathy, and joyful discovery. One mentor. One learner. A world of possibility.
// //         //   </p>

// //         //   <Button className="bg-gradient-to-r from-green-800 to-green-600 hover:from-green-700 hover:to-green-500 text-white rounded-md transition-all duration-300 transform hover:scale-105 w-full xs:w-auto px-6 sm:px-8 md:px-12 lg:px-16 py-3 sm:py-4 lg:py-5 text-sm sm:text-base lg:text-lg font-medium">
// //         //     Join us
// //         //   </Button>
// //         // </div>
...
// //         <div className="flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8 lg:space-y-10">
...
// //         {/*
// //         <div className="flex flex-col items-start justify-center text-left space-y-2 sm:space-y-8 lg:space-y-10">
...
// //           <Button className=" w-64 bg-gradient-to-r from-green-800 to-green-600 hover:from-green-700 hover:to-green-500 text-white rounded-md transition-all duration-300 transform hover:scale-105  xs:w-auto px-6 sm:px-8 md:px-12 lg:px-16 py-3 sm:py-4 lg:py-5 text-sm sm:text-base lg:text-lg font-medium">
// //             Join us
// //           </Button>
// //         </div> */}
...
// export default function Hero() {
//   return (
//     <div className="relative w-full h-[60vh] sm:h-screen flex items-center overflow-hidden">
//       <Image
//         src="/claylab assets/general/HeroSectionImages/mentorshipHero.png"
//         alt="Background"
//         fill
...
//           <Button className="bg-gradient-to-r from-green-800 to-green-600 hover:from-green-700 hover:to-green-500 text-white rounded-md transition-all duration-300 transform hover:scale-105 w-32 xs:w-auto px-6 sm:px-8 md:px-12 lg:px-16 py-3 sm:py-4 lg:py-5 text-sm sm:text-base lg:text-lg font-medium">
//             Join us
//           </Button>
//         </div>
//       </div>
